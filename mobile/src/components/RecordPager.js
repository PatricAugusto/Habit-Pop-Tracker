      ...
      >
        <View style={[styles.page, { width }]}>
          <View style={styles.pageInner}>
            <DailySummary recordCount={recordCount} totals={totals} />
          </View>
        </View>
        {consumptionCards.map((card) => (
          <View key={card.type} style={[styles.page, { width }]}>
            <View style={styles.pageInner}>
              <ConsumptionCard
                card={card}
...
const styles = StyleSheet.create({
  pagerHeader: { flexDirection: "row", alignItems: "baseline", justifyContent: "space-between", paddingHorizontal: 22 },
  ...
  pageInner: { flex: 1, justifyContent: "center", paddingVertical: 12 },
});