...
export const consumptionMeta = {
  beer: { label: "Cerveja", icon: "●", accent: "#FFD84D", artLabel: "PAUSA GELADA" },
  cigarette: { label: "Cigarro", icon: "▰", accent: "#F26A5B", artLabel: "MOMENTO" },
  water: { label: "Água", icon: "◒", accent: "#8ED8E8", artLabel: "PAUSA LEVE" },
